...
const Dlayout = ({children}) => {
    ...
    const todoNavigation = [
        ...
        {
            href:"/Tomorrow",title:"Tomorrow"
        },
        {
            href:"/Overdue",title:"Overdue"
        },
        {
            href:"/Alltodos",title:"Alltodos"
        },
        {
            href:"/Archieve",title:"Archieve"
        },
    ]
  return (
                    ...
                    <a
                        ...
                        className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            ...
                            <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                                ...
                                <span className="ml-3 bg-blue-600 text-white p-2 font-bold rounded-lg">New Task</span>
                            </a>
                    </li>
                </Link>
